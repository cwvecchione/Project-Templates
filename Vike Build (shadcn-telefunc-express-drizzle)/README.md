Generated with [vike.dev/new](https://vike.dev/new) ([version 554](https://www.npmjs.com/package/create-vike/v/0.0.554)) using this command:

```sh
npm create vike@latest --- --react --tailwindcss --shadcn-ui --telefunc --express --drizzle --eslint
```
