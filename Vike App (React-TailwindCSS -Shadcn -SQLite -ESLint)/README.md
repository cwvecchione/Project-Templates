Generated with [vike.dev/new](https://vike.dev/new) ([version 519](https://www.npmjs.com/package/create-vike/v/0.0.519)) using this command:

```sh
npm create vike@latest --- --react --tailwindcss --shadcn-ui --sqlite --eslint
```
